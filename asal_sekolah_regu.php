<tr>
		...
		<td>Asal Sekolah
			: <input type="text" name="asal_sekolah3" id="asal_sekolah3"> 
			Kelas : <select name="kelas3" id="kelas3">
				<option value="4">4</option>
				<option value="5">5</option>
				<option value="6">6</option>
				<option value="7">7</option>
...
<tr>
	...
	<td>Scan Akta Kelahiran : <input type="file" id="akta3" name="akta3"></br>Max size: 3 MB</td>
</tr>
<tr>
	...
	<td>Scan Ijazah : <input type="file" id="ijazah3" name="ijazah3"></br>Max size: 3 MB</td>
</tr>