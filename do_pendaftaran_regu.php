<?php
	...
	$nama3 = mysql_real_escape_string($_POST["nama3"]);
	...
	$insertpeserta3 = mysql_query("INSERT INTO peserta(nm_lengkap, jenis_kelamin, tpt_lahir, tgl_lahir,
														tb, bb, kelas, asal_sekolah, 
														kategori_tanding, golongan, kode_gr,
														kontingen, foto,
														ktp, akta_lahir, ijazah)
