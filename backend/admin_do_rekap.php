<?php
	...
	//kueri kelas tanding untuk judul perekapan data
	$sqlkelasjudul = mysql_query("SELECT * FROM kelastanding WHERE ID_kelastanding='$kelas_tanding_FK'");
	$sqlkelas = mysql_fetch_array($sqlkelasjudul);
...
<h2>
	...
	if($kelas_tanding_FK == '') {
			...
			echo strtoupper($sqlkelas['nm_kelastanding']); 
		} 
