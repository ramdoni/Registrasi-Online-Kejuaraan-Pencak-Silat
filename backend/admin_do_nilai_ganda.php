<?php 
  ...
  $nm_kejuaraan = mysql_real_escape_string($_POST["nm_kejuaraan"]);
...
-->
   ...
   <style type="text/css">
     .background
     {
       ...
       padding-left:5pt;
       padding-top:5pt;
       background: url("images/formnilai_ganda.png") top no-repeat;
     }
   </style>
...
<?php while($jadwal = mysql_fetch_array($jadwal_tgr)) { ?>
