...
<div align="center">
	<table>
		...
		<tr bgcolor="#eeeeee">
			<td><?php echo $no; ?></td>
			<td><A HREF="admin_detail_tgr.php?ID_peserta=<?php echo $peserta['ID_peserta']; ?>" target="_blank"><?php echo $peserta['nm_lengkap']; ?></A></td>
			...
			<td class="non-printable">
				...
				<a href=admin_edit_peserta_tgr.php?ID_peserta=<?php echo $peserta['ID_peserta']; ?> > <img src="images/edit.png"></a>
			</td>
		</tr>
		<?php } ?>
	</table>
