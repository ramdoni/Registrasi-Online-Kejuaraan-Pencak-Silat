...
<h1>EDIT Peserta Tanding</h1>
<div>
<form name="EditPeserta" id="EditPeserta" method="POST" action="admin_do_edit_peserta.php">
	<table border="1">
		<tr>
			<td>Nama Peserta</td>
		...
		<tr>
			...
			<td>
				...
				<?php while($kelastanding = mysql_fetch_array($carikelas)) { ?>
				<option value="<?php echo $kelastanding[0]; ?>" <?php if($kelastanding[0] == $peserta["kelas_tanding_FK"]) { echo "selected"; } ?>><?php echo $kelastanding[1]; ?></option>
				<?php } ?>
		</select>
			</td>
		</tr>
