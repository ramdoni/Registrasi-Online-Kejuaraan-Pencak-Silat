<?php
	...
	$sqlpeserta ="SELECT * FROM peserta
					...
					ORDER BY peserta.kontingen,peserta.kode_gr ASC";
 ...
 <head>
  <style type="text/css">
	 	 .background
		 {
		    ...
		    padding-left:5pt;
		    padding-top:5pt;
		    background: url("images/back_idcard.png") no-repeat;
...
<?php while($data=mysql_fetch_array($datapeserta)) { ?>
...
<form name='peserta'>
	 ...
	 <tr>
	 	...
	 	<h3>
	 	<?php
	 	echo strtoupper($data['kategori_tanding']);
