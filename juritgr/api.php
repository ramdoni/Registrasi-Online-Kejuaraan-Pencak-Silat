	...
	switch($param)
	{
		...
		case "plus_regu":
			...
			if($row)
			{
				...
				$nilai = mysql_query("SELECT jurus". $jurus ." FROM nilai_regu WHERE id_jadwal='{$id_jadwal}' and id_juri='{$id_juri}'");
				$nilai = mysql_fetch_row($nilai);
		...
		case "add_undo_minus_tunggal":
			...
			if($row)
			{
				...
				$nilai = mysql_query("SELECT jurus". $jurus ." FROM nilai_tunggal WHERE id_jadwal='{$id_jadwal}' and id_juri='{$id_juri}'");
				$nilai = mysql_fetch_row($nilai);
...
function get_data_view_ganda()
{
	...
	$jadwal_tunggal = mysql_query($sqljadwal);
	 
	?>
	<?php while ($jadwal = mysql_fetch_array($jadwal_tunggal)) { ?>
	<tr class="text-center">
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {

				$serang = mysql_query("SELECT teknik_serang FROM nilai_ganda WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($serang);
				$serang = $row[0];
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$kompak = mysql_query("SELECT mantap_kompak FROM nilai_ganda WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($kompak);
				$kompak = $row[0];
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$serasi = mysql_query("SELECT serasi FROM nilai_ganda WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($serasi);
				$serasi = $row[0];
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$hukum = mysql_query("SELECT hukum_1,hukum_2,hukum_3,hukum_4,hukum_5,hukum_6 FROM nilai_ganda WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($hukum);
	...
	<tr class="text-center">
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$kebenaran = mysql_query("SELECT jurus1, jurus2, jurus3, jurus4, jurus5, jurus6, jurus7, jurus8, jurus9, jurus10, jurus11, jurus12 FROM nilai_regu WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($kebenaran);
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$kemantapan = mysql_query("SELECT kemantapan FROM nilai_regu WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($kemantapan);
				$kemantapan = $row[0];
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$hukum = mysql_query("SELECT hukum_1,hukum_2,hukum_3,hukum_4 FROM nilai_regu WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($hukum);
	...
	<tr class="text-center">
		...
		<?php
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$kebenaran = mysql_query("SELECT * FROM nilai_tunggal WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($kebenaran);
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				$kemantapan = mysql_query("SELECT kemantapan FROM nilai_tunggal WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($kemantapan);
				$kemantapan = $row[0];
		...
		<td>
			...
			while ($juri = mysql_fetch_array($exec)) {
				...
				$hukuman = mysql_query("SELECT hukum_1,hukum_2,hukum_3,hukum_4,hukum_5 FROM nilai_tunggal WHERE id_juri=". $juri['id_juri'] ." AND id_jadwal=". $jadwal['id_partai']);
				$row = mysql_fetch_row($hukuman);
